#PDD outcome Reward Prediction Amplitdude Modulation
...
subject_list = read.csv("C:/Users/jacobmer/Desktop/PDD_outcome/Subect_list_test.csv", FALSE)


#for subject_iter = 1:size(subject_list,1)
#for subject_iter = 1:64 # 64 is how many seq there are in that frame
  # subject = subject_list(subject_iter,1)
  # k = subject_list(subject_iter,2)
  # h = subject_list(subject_iter,3)
  #add same for kB and hB
...
# ---------------- Read Data
filename1 = ("C:/Users/jacobmer/Desktop/PDD_outcome/MARC8702-0810_A_PDD_NTX_fMRI.csv")
file1 = read.csv(filename1, FALSE)
  DATA1 = file1[-1,]
  DATA1B = DATA1[-1,]
  

#filename2 = ("C:/Users/jacobmer/Desktop/PDD_outcome/MARC8702-0810_B_PDD_NTX_fMRI.csv")
 # file2 = read.csv(filename2, FALSE)
 # DATA2 = file2[-1,]
  #DATA2B = DATA2[-1,]
...
# 2 Pulse
# 3 Trial #
# 4 Reward (20, 60, 100, 140)
# 5 Probability (25, 33, 50, 100)
# 6 Delay (0, 4, 8, 12)
# 7 Order
# 8 Jitter
# 9 Response
...
# Order 1 = Reward, Prob, Delay
# Order 2 = Reward, Delay, Prob
# Order 3 = Prob, Delay, Reward
# Order 4 = Prob, Reward, Delay
# Order 5 = Delay, Prob, Reward
# Order 6 = Delay, Reward, Prob

# Trial is 10 seconds long. Stim 1 occurs 1 second after pulse, stim 2
# 3.5 seconds after pulse, stim 3 6 sec after pulse. Stim 1 and 2 are
# presented for 2.5 seconds, stim 3 appears with 2 and 1 for 1.5 seconds
# before being replaced with fixation cross for 2.5 seconds. Subjects
# have 4 seconds to respond from beginning of 3rd stim. Jitter is added
# to the 10 second trial. Outcome is presented at end of jitter.
...
#______ Matlab scripts below this line
